...
export function PlanView() {
  ...
  <button className="icon-button" aria-label="참고 도면 제거" onClick={()=>{patchProject({sourcePlan:undefined,planImageUrl:undefined,planReference:undefined,planLabels:undefined,planAnalysis:undefined});setCalibrating(false);setAnchors([]);}}><X size={15}/></button></>}
