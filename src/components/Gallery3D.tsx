...
export function Gallery3D({ reset, onCaptureReady, cutaway }: { reset: number; onCaptureReady: (capture: () => void) => void; cutaway: boolean }) {
  ...
  const floor = useMemo(() => deriveFloor(project.walls), [project.walls]);
