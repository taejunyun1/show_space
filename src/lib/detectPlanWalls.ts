...
export async function detectPlanWalls(imageUrl:string,threshold:number,minLengthRatio:number,signal:AbortSignal,minThicknessPx=2):Promise<WallCandidate[]>{
